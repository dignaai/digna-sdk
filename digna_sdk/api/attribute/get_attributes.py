...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ApiError | list[Attribute] | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ApiError | list[Attribute]]:
    return Response(
...
) -> Response[ApiError | list[Attribute]]:
    """get_attributes
    
    Tag: attribute
    Operation: GET /v1/attributes
