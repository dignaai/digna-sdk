...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/v1/data-sources/{data_source_id}".format(data_source_id=quote(str(data_source_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Tag: data_source
    Operation: DELETE /v1/data-sources/{data_source_id}
    
    Parameters:
        - data_source_id (path, required=True): Data source ID
    
    Responses:
        - 204: Delete a data source
