...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ApiError | list[DataSet] | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ApiError | list[DataSet]]:
    return Response(
...
) -> Response[ApiError | list[DataSet]]:
    """get_data_sets
    
    Tag: data_set
    Operation: GET /v1/data-sets
