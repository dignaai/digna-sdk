...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ApiError | list[Project] | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ApiError | list[Project]]:
    return Response(
...
) -> Response[ApiError | list[Project]]:
    """get_projects
    
    Tag: project
    Operation: GET /v1/projects
