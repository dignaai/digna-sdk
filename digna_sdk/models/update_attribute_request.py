...
T = TypeVar("T", bound="UpdateAttributeRequest")



@_attrs_define
class UpdateAttributeRequest:
    """Model for UpdateAttributeRequest.
    ...
    Attributes:
        ...
        statistic_ids (list[int], required=True): No description
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_attribute_request.additional_properties = d
        return update_attribute_request
