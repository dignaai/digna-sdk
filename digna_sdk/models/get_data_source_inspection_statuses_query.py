...
class GetDataSourceInspectionStatusesQuery:
    """Model for GetDataSourceInspectionStatusesQuery.
    
    Attributes:
        data_analytics_status (Any, required=False): No description
        data_anomaly_status (Any, required=False): No description
        data_source_id (Any, required=False): No description
        data_source_name_like (Any, required=False): No description
        ...
        inspection_status (Any, required=False): No description
        is_inspected (Any, required=False): No description
        limit (Any, required=False): No description
        project_id (Any, required=False): No description
