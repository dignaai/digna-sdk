...
@_attrs_define
class DbConnection:
    """Model for DbConnection.
    
    Attributes:
        id (int, required=True): No description
        name (str, required=True): No description
        profiling_mode (StableDbConnectionProfilingMode, required=True): No description
        technology (StableDbConnectionTechnology, required=True): No description
        work_schema (str, required=True): No description
    """
