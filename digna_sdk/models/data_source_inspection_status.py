...
if TYPE_CHECKING:
  from ..models.data_source_inspection_status_data_analytics_data_source_status import DataSourceInspectionStatusDataAnalyticsDataSourceStatus
  from ..models.data_source_inspection_status_data_anomaly_status import DataSourceInspectionStatusDataAnomalyStatus
  from ..models.data_source_inspection_status_data_source import DataSourceInspectionStatusDataSource
  from ..models.data_source_inspection_status_data_validation_status import DataSourceInspectionStatusDataValidationStatus
  from ..models.data_source_inspection_status_data_volume_status import DataSourceInspectionStatusDataVolumeStatus
...
class DataSourceInspectionStatus:
    """Model for DataSourceInspectionStatus.
    
    Attributes:
        data_analytics_status (Any, required=False): No description
        data_anomaly_status (Any, required=False): No description
        data_source (DataSourceInspectionStatusDataSource, required=True): No description
        data_validation_status (Any, required=False): No description
        data_volume_status (Any, required=False): No description
        inspected_at (Any, required=False): No description
        is_inspected (bool, required=True): No description
        project (DataSourceInspectionStatusProject, required=True): No description
    ...
    data_analytics_status: DataSourceInspectionStatusDataAnalyticsDataSourceStatus | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.data_analytics_status, DataSourceInspectionStatusDataAnalyticsDataSourceStatus):
        ...
        elif isinstance(self.data_validation_status, DataSourceInspectionStatusDataValidationStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data_analytics_status(data: object) -> DataSourceInspectionStatusDataAnalyticsDataSourceStatus | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_analytics_status_type_1 = DataSourceInspectionStatusDataAnalyticsDataSourceStatus.from_dict(data)
                ...
                pass
            return cast(DataSourceInspectionStatusDataAnalyticsDataSourceStatus | None | Unset, data)

        data_analytics_status = _parse_data_analytics_status(d.pop("data_analytics_status", UNSET))


        def _parse_data_anomaly_status(data: object) -> DataSourceInspectionStatusDataAnomalyStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_anomaly_status_type_1 = DataSourceInspectionStatusDataAnomalyStatus.from_dict(data)
        ...
        def _parse_data_validation_status(data: object) -> DataSourceInspectionStatusDataValidationStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_validation_status_type_1 = DataSourceInspectionStatusDataValidationStatus.from_dict(data)
        ...
        def _parse_data_volume_status(data: object) -> DataSourceInspectionStatusDataVolumeStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_volume_status_type_1 = DataSourceInspectionStatusDataVolumeStatus.from_dict(data)
