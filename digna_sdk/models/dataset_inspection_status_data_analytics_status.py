...
T = TypeVar("T", bound="DatasetInspectionStatusDataAnalyticsStatus")



@_attrs_define
class DatasetInspectionStatusDataAnalyticsStatus:
    """Model for DatasetInspectionStatusDataAnalyticsStatus.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_inspection_status_data_analytics_status = cls(
            num_failed=num_failed,
            num_not_relevant=num_not_relevant,
            num_passed=num_passed,
            status=status,
        ...
        dataset_inspection_status_data_analytics_status.additional_properties = d
        return dataset_inspection_status_data_analytics_status
