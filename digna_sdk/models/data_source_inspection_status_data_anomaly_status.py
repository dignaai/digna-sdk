...
T = TypeVar("T", bound="DataSourceInspectionStatusDataAnomalyStatus")



@_attrs_define
class DataSourceInspectionStatusDataAnomalyStatus:
    """Model for DataSourceInspectionStatusDataAnomalyStatus.
    
    Attributes:
        num_checks (int, required=True): No description
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data_source_inspection_status_data_anomaly_status = cls(
            num_checks=num_checks,
            num_failed=num_failed,
            num_passed=num_passed,
            num_uncertain=num_uncertain,
        ...
        data_source_inspection_status_data_anomaly_status.additional_properties = d
        return data_source_inspection_status_data_anomaly_status
