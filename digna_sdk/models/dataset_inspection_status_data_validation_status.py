...
T = TypeVar("T", bound="DatasetInspectionStatusDataValidationStatus")



@_attrs_define
class DatasetInspectionStatusDataValidationStatus:
    """Model for DatasetInspectionStatusDataValidationStatus.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_inspection_status_data_validation_status = cls(
            num_failed=num_failed,
            num_passed=num_passed,
            num_uncertain=num_uncertain,
            status=status,
        ...
        dataset_inspection_status_data_validation_status.additional_properties = d
        return dataset_inspection_status_data_validation_status
