...
if TYPE_CHECKING:
    from ..models.dataset_inspection_status_data_analytics_status import (
        DatasetInspectionStatusDataAnalyticsStatus,
    )
    from ..models.dataset_inspection_status_data_anomaly_status import (
    ...
    from ..models.dataset_inspection_status_data_validation_status import (
        DatasetInspectionStatusDataValidationStatus,
    )
    from ..models.dataset_inspection_status_data_volume_status import (
    ...
    from ..models.dataset_inspection_status_dataset_definition import (
...
class DatasetInspectionStatus:
    ...
    Attributes:
        ...
        data_analytics_status (DatasetInspectionStatusDataAnalyticsStatus | None | Unset):
        data_anomaly_status (DatasetInspectionStatusDataAnomalyStatus | None | Unset):
        data_validation_status (DatasetInspectionStatusDataValidationStatus | None | Unset):
        data_volume_status (DatasetInspectionStatusDataVolumeStatus | None | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.dataset_inspection_status_data_source import DatasetInspectionStatusDataSource  # noqa: PLC0415
        from ..models.dataset_inspection_status_data_validation_status import (
            DatasetInspectionStatusDataValidationStatus,
        )  # noqa: PLC0415
        from ..models.dataset_inspection_status_data_volume_status import (
        ...
        from ..models.dataset_inspection_status_dataset import DatasetInspectionStatusDataset  # noqa: PLC0415
        from ..models.dataset_inspection_status_dataset_definition import (
            DatasetInspectionStatusDatasetDefinition,
        )  # noqa: PLC0415
        from ..models.dataset_inspection_status_project import DatasetInspectionStatusProject  # noqa: PLC0415
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_definition = DatasetInspectionStatusDatasetDefinition.from_dict(
            d.pop("dataset_definition")
        )
        ...
        def _parse_data_analytics_status(
            data: object,
        ) -> DatasetInspectionStatusDataAnalyticsStatus | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_analytics_status_type_1 = DatasetInspectionStatusDataAnalyticsStatus.from_dict(
                    data
                )
        ...
        def _parse_data_anomaly_status(
            data: object,
        ) -> DatasetInspectionStatusDataAnomalyStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_anomaly_status_type_1 = DatasetInspectionStatusDataAnomalyStatus.from_dict(
                    data
                )
        ...
        def _parse_data_validation_status(
            data: object,
        ) -> DatasetInspectionStatusDataValidationStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                data_validation_status_type_1 = (
                    DatasetInspectionStatusDataValidationStatus.from_dict(data)
                )
        ...
        def _parse_data_volume_status(
            data: object,
        ) -> DatasetInspectionStatusDataVolumeStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
